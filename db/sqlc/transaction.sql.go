...
RETURNING id, from_account_id, to_account_id, created_at, ammount
`
...
func (q *Queries) CreateTransaction(ctx context.Context, arg CreateTransactionParams) (Transaction, error) {
	row := q.db.QueryRowContext(ctx, createTransaction, arg.FromAccountID, arg.ToAccountID, arg.Ammount)
	var i Transaction
	err := row.Scan(
		&i.ID,
		&i.FromAccountID,
...
SELECT id, from_account_id, to_account_id, created_at, ammount FROM transactions 
WHERE id  = $1
LIMIT 1
`
